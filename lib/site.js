...
export const portrait = {
  ...
  caption: "Most Saturdays look something like this.",
};
...
export const manifest = [
  ...
  { key: "Building", val: "A new product most years. DadLifts and RecitePath are current." },
...
export const projects = [
  ...
  },
  {
    ...
    meta: "In progress",
    href: "",
    desc: "Audio-first spaced repetition for classical memory work: catechism, Scripture, Latin, timeline. Built because my homeschooled kids learn by speaking, not by staring at a screen.",
